            ...
            <>
                ...
                <div className="flex w-full items-center justify-between md:w-auto">
                  <Link href="/" className="flex flex-col items-center dark:hidden">
                    {props.logo ? (
                      ...
                      <div className="text-center">
                        <span className="block text-xl font-bold text-gray-800 dark:text-gray-100">
                          Uywakuna
                        </span>
                  ...
                  <Link href="/" className="hidden flex-col items-center dark:flex">
                    {(props.logoalt || props.logo) ? (
                      ...
                      <div className="text-center">
                        <span className="block text-xl font-bold text-gray-100">
                          Uywakuna
                        </span>
              ...
              <Disclosure.Panel>
                <div className="order-2 -ml-4 mt-4 flex w-full flex-col items-center justify-start md:hidden">
                  ...
                  <div className="mt-2 w-full border-t border-gray-200 pt-2 dark:border-gray-700">
